    ...
    def __init__(self, data_config, pretrain_data):
        ...
        *********************************************************
        ...
        Different Convolutional Layers:
            1. cgcf: Our model in "Combining social relations and interaction data in Recommender System with Graph Convolution Collaborative Filtering";
        ...
        self.ua_embeddings, self.ia_embeddings = self._create_gccf_embed()
...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    """
    interaction_adj, social_adj, similar_users_adj, _ = data_generator.get_norm_adj_mat()
    ...
    if args.pretrain == -1:
        ...
        pretrain_data = None
    model = GCCF(data_config=config, pretrain_data=pretrain_data)
